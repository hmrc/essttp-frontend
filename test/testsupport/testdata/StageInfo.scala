...
object StageInfo {
  ...
  val enteredDetailsAboutBankAccountNotAccountHolder: StageInfo = StageInfo("EnteredCanYouSetUpDirectDebit", "CannotSetUpDirectDebit")
  val enteredDetailsAboutBankAccountIsAccountHolder: StageInfo = StageInfo("EnteredCanYouSetUpDirectDebit", "CanSetUpDirectDebit")
