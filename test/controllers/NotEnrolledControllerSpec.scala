...
class NotEnrolledControllerSpec extends ItSpec {
  ...
  "GET /not-enrolled should" - {
    "return the not enrolled page" in {
      ...
      commonIneligibilityTextCheck(page, TaxRegime.Epaye)
    }
  }
  ...
  "GET /not-vat-registered should" - {
    "return the not vat registered page" in {
      ...
      commonIneligibilityTextCheck(page, TaxRegime.Vat)
    }
  }

  private def commonIneligibilityTextCheck(doc: Document, taxRegime: TaxRegime) = {
