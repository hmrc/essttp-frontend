...
class DatesApiController @Inject() (
  ...
  def getExtremeDatesAndUpdateJourney(
    ...
    } yield Redirect(Routing.next(routes.DatesApiController.retrieveExtremeDates, updatedJourney))
  }
  ...
  def getStartDatesAndUpdateJourney(
    ...
    } yield Redirect(Routing.next(routes.DatesApiController.retrieveStartDates, updatedJourney))
  }
