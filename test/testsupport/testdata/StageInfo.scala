...
object StageInfo {
  ...
  val enteredDetailsAboutBankAccount: StageInfo = StageInfo("EnteredDetailsAboutBankAccount", "Business")
  val enteredDetailsAboutBankAccountPersonal: StageInfo = StageInfo("EnteredDetailsAboutBankAccount", "Personal")
  val enteredDetailsAboutBankAccountNotAccountHolder: StageInfo = StageInfo("EnteredDetailsAboutBankAccount", "IsNotAccountHolder")
