...
object JourneyInfo {
  ...
  def taxId(taxReference: String, taxRegime: TaxRegime): JourneyInfoAsJson =
  ...
  def ineligibleInChargTypeAssessments(
    taxRegime:              TaxRegime,
    ...
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = assessmentCategoryInfo
    )
  ...
  def ineligibleMinDebt(
    ...
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      assessmentCategories =
        Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleIsLessThanMinDebtAllowance))
    )
  def ineligibleMaxDebt(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    ...
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      encrypter,
      assessmentCategories =
        Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleIsMoreThanMaxDebtAllowance))
    )
  def ineligibleDisallowedCharge(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleDisallowedChargeLockTypes))
    )
  ...
  def ineligibleMaxDebtAge(
    ...
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleExceedsMaxDebtAge))
    )
  def ineligibleBeforeMaxAccountingDate(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      encrypter,
      assessmentCategories =
        Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleChargesBeforeMaxAccountingDate))
    )
  def ineligibleChargeType(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleEligibleChargeType))
    )
  ...
  def ineligibleNoDueDatesReached(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleNoDueDatesReached))
    )
  ...
  def ineligibleChargesBeforeMaxAccountingDate(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
  ...
  def multipleIneligibleReasonsDebtTooLowAndOld(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
  ...
  def multipleIneligibleReasonsEligibilityReasons(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
  ...
  def multipleIneligibleReasonsAssessmentEligibilityReasons(
    ...
    TdJsonBodies.eligibilityCheckJourneyInfo(
      ...
      taxRegime,
      encrypter,
      assessmentCategories = Seq(AssessmentCategoryInfo(assessmentCategory, TdAll.notEligibleMultipleReasonsAssessment))
    )
  def multipleIneligibleReasonsOneFromEachReasonsList(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): JourneyInfoAsJson =
  ...
  def taxIdDetermined(taxReference: String = "864FZ00049", taxRegime: TaxRegime): List[JourneyInfoAsJson] =
  ...
  def eligibilityCheckedIneligibleInChargeTypesAssessments(
    taxRegime:              TaxRegime,
    assessmentCategoryInfo: Seq[AssessmentCategoryInfo],
    encrypter:              Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleInChargTypeAssessments(taxRegime, assessmentCategoryInfo, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )

  def eligibilityCheckedIneligibleHasRls(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    ineligibleHasRls(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedNoMtdEnrolment(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    noMtdEnrolment(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedMarkedAsInsolvent(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    ineligibleMarkedAsInsolvent(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMinDebt(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleMinDebt(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMaxDebt(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    eligibilityRules:   EligibilityRules,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleMaxDebt(taxRegime, assessmentCategory, eligibilityRules, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )

  def eligibilityCheckedIneligibleDisallowedCharge(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleDisallowedCharge(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleExistingTtp(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    ineligibleExistingTtp(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMaxDebtAge(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleMaxDebtAge(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleBeforeMaxAccountingDate(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleBeforeMaxAccountingDate(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )

  def eligibilityCheckedIneligibleChargeType(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleChargeType(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMissingFiledReturns(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleMissingFiledReturns(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleNoDueDatesReached(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleNoDueDatesReached(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleHasInvalidInterestSignals(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleHasInvalidInterestSignals(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleHasInvalidInterestSignalsCESA(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleHasInvalidInterestSignalsCESA(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleDmSpecialOfficeProcessingRequired(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleDmSpecialOfficeProcessingRequired(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleCannotFindLockReason(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleCannotFindLockResponse(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleCreditsNotAllowed(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleCreditsNotAllowed(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleIsMoreThanMaxPaymentReference(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleIsMoreThanMaxPaymentReference(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedChargesBeforeMaxAccountingDate(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleChargesBeforeMaxAccountingDate(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )

  def eligibilityCheckedIneligibleChargesBeforeMaxAccountingDate(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
  ...
  def eligibilityCheckedIneligibleHasDisguisedRemuneration(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleHasDisguisedRemuneration(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleHasCapacitor(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    ineligibleHasCapacitor(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleDmSpecialOfficeProcessingRequiredCDCS(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleDmSpecialOfficeProcessingRequiredCDCS(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleIsAnMtdCustomer(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    ineligibleisAnMtdCustomer(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleDmSpecialOfficeProcessingRequiredCESA(
    taxRegime: TaxRegime,
    encrypter: Encrypter
  ): List[JourneyInfoAsJson] =
    ineligibleDmSpecialOfficeProcessingRequiredCESA(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMultipleReasons(taxRegime: TaxRegime, encrypter: Encrypter): List[JourneyInfoAsJson] =
    multipleIneligibleReasons(taxRegime, encrypter) :: taxIdDetermined(taxRegime = taxRegime)

  def eligibilityCheckedIneligibleMultipleReasonsDebtTooLowAndOld(
    taxRegime:          TaxRegime,
    assessmentCategory: AssessmentCategory,
    encrypter:          Encrypter
  ): List[JourneyInfoAsJson] =
    multipleIneligibleReasonsDebtTooLowAndOld(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )
  ...
  def eligibilityCheckedIneligibleMultipleReasonsEligibilityReasons(
    ...
    multipleIneligibleReasonsEligibilityReasons(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(taxRegime =
      taxRegime
    )
  ...
  def eligibilityCheckedIneligibleMultipleReasonsAssessmentEligibilityReasons(
    ...
    multipleIneligibleReasonsAssessmentEligibilityReasons(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(
      taxRegime = taxRegime
    )
  ...
  def eligibilityCheckedIneligibleMultipleOneFromEach(
    ...
    multipleIneligibleReasonsOneFromEachReasonsList(taxRegime, assessmentCategory, encrypter) :: taxIdDetermined(
      taxRegime = taxRegime
    )
  ...
  def `agreedTermsAndConditions - padded account number`(
    ...
    taxRegime:              TaxRegime,
    encrypter:              Encrypter,
    etmpEmail:              Option[String] = None
  ): List[JourneyInfoAsJson] =
    emailAddressRequired(isEmailAddressRequired) :: `confirmedDirectDebitDetails - padded account number`(
      taxRegime,
      encrypter,
      etmpEmail
    )

  def selectedEmailToBeVerified(
    email:             String,
    taxRegime:         TaxRegime,
    encrypter:         Encrypter,
    etmpEmail:         Option[String] = Some(TdAll.etmpEmail),
    ...
    emailToBeVerified(email, encrypter) :: agreedTermsAndConditions(
      isEmailAddressRequired = true,
      taxRegime,
      encrypter,
      etmpEmail,
      withAffordability = withAffordability
    )

  def emailVerificationComplete(
    email:             String,
    ...
    emailVerificationResult(result) :: emailVerificationAnswersEmailRequired(
      email,
      result,
      encrypter
    ) :: selectedEmailToBeVerified(email, taxRegime, encrypter, withAffordability = withAffordability)

  def emailVerificationAnswers(
    isEmailAddressRequired: Boolean,
    taxRegime:              TaxRegime,
    encrypter:              Encrypter,
    withAffordability:      Boolean = false
  ): List[JourneyInfoAsJson] =
    emailVerificationAnswersNoEmailRequired :: agreedTermsAndConditions(
  ...
  def submittedArrangementWithUpfrontPayment(
    taxRegime:         TaxRegime,
    encrypter:         Encrypter,
    withAffordability: Boolean = false
  ): List[JourneyInfoAsJson] =
    arrangementSubmitted(taxRegime) :: emailVerificationAnswers(
  ...
  def submittedArrangementNoUpfrontPayment(
    taxRegime:         TaxRegime,
    encrypter:         Encrypter,
    withAffordability: Boolean = false
  ): List[JourneyInfoAsJson] =
