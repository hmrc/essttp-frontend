...
@Singleton
class Crypto @Inject() (appConfig: AppConfig) extends Encrypter with Decrypter {
  implicit def aesCrypto: Encrypter with Decrypter = SymmetricCryptoFactory.aesGcmCrypto(appConfig.Crypto.aesGcmCryptoKey)
