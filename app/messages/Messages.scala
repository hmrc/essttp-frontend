...
object Messages {
  ...
  object YourBill {
    ...
    val `Here, you can view the total of all your Simple Assessment debts...` : Message = Message(
      english =
        "Here, you can view the total of all your Simple Assessment debts. In your Personal Tax Account, you can only view your debts from the last 4 tax years.",
      welsh =
        "Yma, gallwch fwrw golwg dros gyfanswm eich holl ddyledion Asesiad Syml. Bydd eich Cyfrif Treth Personol dim ond yn dangos eich dyledion o’r 4 flwyddyn dreth ddiwethaf."
    )
  ...
  object TermsAndConditions {
    ...
    val `Accept and send`: Message = Message(
      english = "Accept and send",
