  ...
  "POST /how-much-can-you-pay-upfront" - {
    ...
    forAll(
      Table(
        ...
        ("x > maximum debt", "30001", "How much you can pay upfront must be £3,000 or less"),
        ("x < 1", "0.99", "How much you can pay upfront must be £1 or more"),
        ("x < 0", "-1", "How much you can pay upfront must be £1 or more"),
        ("x = 0", "0", "How much you can pay upfront must be £1 or more"),
