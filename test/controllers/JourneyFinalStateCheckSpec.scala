    ...
    forAll(
      Table(
        ...
        (
          ...
          app.injector.instanceOf[UpfrontPaymentController].canYouMakeAnUpfrontPayment
        ),
        ...
        (
          ...
          app.injector.instanceOf[DetermineAffordabilityController].determineAffordability
        ),
        (
          PageUrls.canPayWithinSixMonthsUrl(Epaye, None),
          app.injector.instanceOf[CanPayWithinSixMonthsController].canPayWithinSixMonths(Epaye, None)
        ),
        (
          PageUrls.howMuchCanYouPayEachMonthUrl,
          app.injector.instanceOf[MonthlyPaymentAmountController].displayMonthlyPaymentAmount
        ),
        ...
        (
          ...
          app.injector.instanceOf[DetermineAffordableQuotesController].retrieveAffordableQuotes
        ),
