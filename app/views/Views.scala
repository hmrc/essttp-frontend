...
import views.html.{CanYouMakeAnUpfrontPayment, UpfrontPaymentAmount, UpfrontSummary, YourBillIs}
...
class Views @Inject() (
    ...
    val upfrontPaymentAmountPage:   UpfrontPaymentAmount,
    val upfrontSummaryPage:         UpfrontSummary
)
