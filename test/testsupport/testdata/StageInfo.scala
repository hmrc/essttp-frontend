...
object StageInfo {
  ...
  val chosenTypeOfBankAccountBusiness: StageInfo = StageInfo("ChosenTypeOfBankAccount", "Business")
  val chosenTypeOfBankAccountPersonal: StageInfo = StageInfo("ChosenTypeOfBankAccount", "Personal")
