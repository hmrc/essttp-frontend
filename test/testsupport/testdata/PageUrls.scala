...
object PageUrls {
  ...
  val tooManyPasscodeJourneysStartedUrl: String = s"$serviceBaseUrl/too-many-passcodes"
  val tooManyEmailAddressesEnteredUrl: String = s"$serviceBaseUrl/too-many-email-addresses"
