    ...
    "POST /terms-and-conditions should" - {
      ...
      s"[$regime journey] redirect the user to submit arrangement if regimeDigitalCorrespondence is false and update backend" in {
        ...
        EssttpBackend.ConfirmedDirectDebitDetails
          .findJourney(testCrypto, origin)(
            JourneyJsonTemplates.`Confirmed Direct Debit Details - regimeDigitalCorrespondence flag`(
              origin,
        ...
        EssttpBackend.TermsAndConditions.stubUpdateAgreedTermsAndConditions(
          ...
          JourneyJsonTemplates
            .`Agreed Terms and Conditions`(isEmailAddresRequired = false, origin, Some(TdAll.etmpEmail))
        )
        ...
        EssttpBackend.TermsAndConditions
          .verifyUpdateAgreedTermsAndConditionsRequest(TdAll.journeyId, IsEmailAddressRequired(value = false))
      }
      ...
      s"[$regime journey] redirect the user to the email journey if regimeDigitalCorrespondence is enabled and update backend" +
        s" and there is an email address in the eligibility check result" in {
          ...
          EssttpBackend.TermsAndConditions.stubUpdateAgreedTermsAndConditions(
            TdAll.journeyId,
            JourneyJsonTemplates
              .`Agreed Terms and Conditions`(isEmailAddresRequired = true, origin, Some(TdAll.etmpEmail))
          )
          ...
          EssttpBackend.TermsAndConditions
            .verifyUpdateAgreedTermsAndConditionsRequest(TdAll.journeyId, IsEmailAddressRequired(value = true))
        }
  ...
  Seq[(String, Origin)](
    ...
    "POST /terms-and-conditions should" - {
      ...
      s"[$regime journey] redirect the user to the submit arrangement endpoint if the our email journey feature flag is false and update backend" in {
        ...
        EssttpBackend.TermsAndConditions.stubUpdateAgreedTermsAndConditions(
          TdAll.journeyId,
          JourneyJsonTemplates.`Agreed Terms and Conditions`(
            isEmailAddresRequired = false,
            origin = origin,
