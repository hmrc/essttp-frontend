...
object StageInfo {
  ...
  val enteredCanSetUpDirectDebitIsNotAccountHolder: StageInfo = StageInfo("EnteredCanYouSetUpDirectDebit", "CannotSetUpDirectDebit")
  val enteredCanSetUpDirectDebitIsAccountHolder: StageInfo = StageInfo("EnteredCanYouSetUpDirectDebit", "CanSetUpDirectDebit")
