...
object PageUrls {
  ...
  val simpLandingPageUrl: String              = s"$serviceBaseUrl/simple-assessment-payment-plan"
  ...
  val determineAssessmentCategoryUrl: String  = s"$serviceBaseUrl/determine-assessment-category"
  ...
  val simpNotEligibleUrl: String              = s"$serviceBaseUrl/not-eligible-simple-assessment"
  ...
  val simpDebtTooLargeUrl: String             = s"$serviceBaseUrl/debt-too-large-simple-assessment"
  ...
  val yourBillCombinedUrl: String             = s"$serviceBaseUrl/your-bill-combined"
  ...
  val simpConfirmationUrl: String                                                                     = s"$serviceBaseUrl/simple-assessment-payment-plan-set-up"
